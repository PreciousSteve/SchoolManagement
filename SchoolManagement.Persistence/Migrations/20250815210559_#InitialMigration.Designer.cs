...
namespace SchoolManagement.Persistence.Migrations
{
    ...
    [Migration("20250815210559_#InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Enrollment", b =>
                {
                    b.HasOne("SchoolManagement.Domain.Course", "CourseId")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolManagement.Domain.UserManagement.Student", "StudentId")
                        .WithMany("Enrollments")
